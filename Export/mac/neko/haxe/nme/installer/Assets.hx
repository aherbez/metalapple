...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceNames.set ("assets/background.jpg", "assets/background.jpg");
			resourceTypes.set ("assets/background.jpg", "image");
			resourceNames.set ("assets/Dethek_Stone.ttf", "assets/Dethek_Stone.ttf");
			resourceTypes.set ("assets/Dethek_Stone.ttf", "font");
			resourceNames.set ("assets/glass.png", "assets/glass.png");
			resourceTypes.set ("assets/glass.png", "image");
			resourceNames.set ("assets/glass2.png", "assets/glass2.png");
			resourceTypes.set ("assets/glass2.png", "image");
			resourceNames.set ("assets/magglass.png", "assets/magglass.png");
			resourceTypes.set ("assets/magglass.png", "image");
			resourceNames.set ("assets/news.ttf", "assets/news.ttf");
			resourceTypes.set ("assets/news.ttf", "font");
			resourceNames.set ("assets/Windlass.ttf", "assets/Windlass.ttf");
